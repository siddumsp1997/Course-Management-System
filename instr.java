...
public class instr extends JFrame {
	...
	private int a,a1,a2,a3,a4;
	public faculty kk=new faculty();
	public int kp,x;
	
	
	public instr(int i,int cno)
	{   
		...
		{ public void actionPerformed(ActionEvent h)
			{     x=0;
			    a=a1=a2=a3=a4=0;
			      ...
			      {  
			    	  kk.name=textField.getText();
			    	  a=1;
			      }
			      
			      if(!textField_1.getText().equals(""))
			      {  
			    	  kk.department=textField_1.getText();
			    	  a1=1;
			      }
			      
			      if(!textField_2.getText().equals(""))
			      {  
			    	  kk.address=textField_2.getText();
			    	  a2=1;
			      }
			      ...
			      {  
					  ...
					  { x=1;
						...
						kk.mobileno=textField_3.getText();
						a3=1;}
			      }
			      
			      if(!textField_4.getText().equals(""))
			      {  
			    	  kk.email=textField_4.getText();
			    	  a4=1;
			      }
				  ...
				  {
					courselist.courses.get(kp).instructor.add(kk);  
					try {
